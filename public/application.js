...
var showOrder = function showOrder() {
...
var updateOrderCompleted = function updateOrderCompleted() {
...
var showPreviousOrders = function showPreviousOrders() {
...
module.exports = {
  ...
  updateOrderCompleted: updateOrderCompleted
};
...
var showPreviousOrders = __webpack_require__(39);

var showOrderProducts = __webpack_require__(40);

var checkOrderLength = function checkOrderLength() {
...
var createOrderFailure = function createOrderFailure(response) {
  $('#message').text('Adding an order failed. Try again.');
};

var onUpdateOrderSuccess = function onUpdateOrderSuccess(id) {
  // console.log('onUpdateOrderSuccess ui reached!')
  $('#message').text('You have updated an order!');
  api.showOrder().then(onShowOrderSuccess).then(checkOrderLength).catch(onShowOrderFailure);
};

var onUpdateOrderFailure = function onUpdateOrderFailure(response) {
  // console.log('onUpdateOrderFailure ui reached!')
  $('#message').text('Unable to update order! Try again.');
};

var onDeleteOrderSuccess = function onDeleteOrderSuccess(id) {
  // console.log('onDeleteOrderSuccess ui reached!')
  resetForm($('#delete-order'));
  $('#message').text('You have deleted a order!');
};

var onDeleteOrderFailure = function onDeleteOrderFailure(response) {
  // console.log('onDeleteOrderFailure ui reached!')
  $('#message').text('Unable to delete a order! Try again.');
};

var onShowOrderSuccess = function onShowOrderSuccess(data) {
  ...
  var total = products.reduce(function (sum, num) {
    return sum + num.price;
  }, 0);
  store.total = total;
  var showOrderProductsHtml = showOrderProducts({ products: products });
  $('.cart-table').remove();
  $('.shopping-cart').append(showOrderProductsHtml);
  // $('#message').text('You got your cart!')
};

var onShowOrderFailure = function onShowOrderFailure() {
  $('#message').text('Couldn\'t show your shopping cart!');
};

var ShowPreviousOrdersSuccess = function ShowPreviousOrdersSuccess(data) {
  // console.log('ShowPreviousOrdersSuccess ui function reached!')
  // console.log('data is: ', data)
  // console.log('data.orders is: ', data.orders)
  var orders = data.orders;
  var showPreviousOrdersHtml = showPreviousOrders({ orders: orders });
  $('.previous-orders-table').remove();
  $('.previous-orders').empty();
  $('.previous-orders').append(showPreviousOrdersHtml);
};

var ShowPreviousOrdersFailure = function ShowPreviousOrdersFailure(data) {}
...
;module.exports = {
  ...
  onUpdateOrderFailure: onUpdateOrderFailure,
  onDeleteOrderSuccess: onDeleteOrderSuccess,
  onDeleteOrderFailure: onDeleteOrderFailure,
  onShowOrderSuccess: onShowOrderSuccess,
  onShowOrderFailure: onShowOrderFailure,
  ShowPreviousOrdersSuccess: ShowPreviousOrdersSuccess,
  ShowPreviousOrdersFailure: ShowPreviousOrdersFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var showProducts = __webpack_require__(22);
...
var createProductSuccess = function createProductSuccess(response) {
...
var createProductFailure = function createProductFailure(response) {
  $('#message').text('Adding an order failed. Try again.').show().fadeOut(8000);
};

var onUpdateProductSuccess = function onUpdateProductSuccess(id) {
...
var onUpdateProductFailure = function onUpdateProductFailure(response) {
  // console.log('onUpdateProductFailure ui reached!')
  $('#message').text('Unable to update order! Try again.').show().fadeOut(8000);
};

var onDeleteProductSuccess = function onDeleteProductSuccess(id) {
...
module.exports = {
  ...
  createProductFailure: createProductFailure,
...
var ordersApi = __webpack_require__(6);
var ordersUi = __webpack_require__(8);

var onCheckoutSuccess = function onCheckoutSuccess() {
  // console.log('checkout success reached')
  ordersApi.updateOrderCompleted().then(function () {
    return $('#message').show().text('Your order has been purchased.  Thanks for shopping with Nozama.com!').show().fadeOut(8000);
  }).catch(function () {
    return $('#message').show().text('Your charge is complete, but your order has not been updated to purchased.  We will work to rectify this minor error. Do NOT submit your order again or you will be charged twice.').show().fadeOut(8000);
  });
  $('.shopping-cart').empty();
  $('#buttonCheckout').hide();
  ordersApi.createOrder().then(ordersUi.createOrderSuccess).catch(ordersUi.createOrderFailure);
};
...
var productEvents = __webpack_require__(41);
var ordersEvents = __webpack_require__(42);
var swipeEvents = __webpack_require__(43);
...
var store = __webpack_require__(1);
var productsApi = __webpack_require__(10);
var productsUi = __webpack_require__(11);
var ordersApi = __webpack_require__(6);
var ordersUi = __webpack_require__(8);
...
var signInSuccess = function signInSuccess(data) {
  ...
  productsApi.getProduct().then(productsUi.getProductSuccess).catch(productsUi.getProductFailure);
  ordersApi.createOrder().then(ordersUi.createOrderSuccess).catch(ordersUi.createOrderFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<tbody class=\"products-table\">\n  <tr>\n    <th>Name</th>\n    <th>Category</th>\n    <th>Price</th>\n  </tr>\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.purchaseStatus : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "  <tr>\n    <th width=\"250px\">Order #: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "</th>\n  </tr>\n</tbody>\n<tbody class=\"previous-orders-table\">\n  <tr>\n    <th>Name</th>\n    <th width=\"250px\">Category</th>\n    <th>Price</th>\n  </tr>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[1][0]) != null ? stack1.products : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</tbody>\n";
  ...
  return "<!-- previous-orders handlebars-->\n\n<tbody class=\"previous-orders-table\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.orders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <!-- console.log(product) -->\n    <tr>\n      <td>"
    ...
    + "\" name=\"product[id]\">\n          <button type=\"submit\" class=\"btn btn-danger remove-from-cart-btn\">Remove from Cart</button>\n        </form>\n      </td>\n    </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<!-- duplicated the product-list.handlebars code.\n    Need to update with correct syntax -->\n\n<tbody class=\"cart-table\">\n  <tr>\n    <th width=\"150px\">Name</th>\n    <th width=\"150px\">Category</th>\n    <th>Price</th>\n  </tr>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.products : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</tbody>\n";
},"useData":true,"useBlockParams":true});
...
var onUpdateOrderAdd = function onUpdateOrderAdd(event) {
  event.preventDefault();
  if (event.target && event.target.matches('form.order-product')) {
    var products = getFormFields(event.target);
    var data = {
      order: {
        id: store.order.id,
        products: {
    ...
    api.updateOrder(data).then(ui.onUpdateOrderSuccess).catch(ui.onUpdateOrderFailure);
  }
  $('#buttonCheckout').show();
};

var onUpdateOrderRemove = function onUpdateOrderRemove(event) {
  event.preventDefault();
...
var onShowOrder = function onShowOrder(event) {
  event.preventDefault();
  api.showOrder().then(ui.onShowOrderSuccess).catch(ui.onShowOrderFailure);
};

// Show previous orders
var onShowPreviousOrders = function onShowPreviousOrders(event) {
  event.preventDefault();
  // console.log('onShowPreviousOrders events function reached!')
  api.showPreviousOrders().then(ui.ShowPreviousOrdersSuccess).catch(ui.ShowPreviousOrdersFailure);
};
...
var handleToken = function handleToken(token) {
  ...
  }).then(ui.onCheckoutSuccess).catch(ui.onCheckoutFailure);
};
module.exports = {
